...
`;
      ...
      [kDispatch](opts, handler2) {
        ...
        const request = new Request(origin, opts, handler2);
  ...
  "node_modules/undici/lib/mock/mock-agent.js"(exports, module) {
    ...
    var MockAgent = class extends Dispatcher {
      constructor(opts) {
        ...
        const agent2 = opts?.agent ? opts.agent : new Agent2(opts);
        this[kAgent] = agent2;
        ...
        return new Promise((resolve, reject) => agent2.dispatch(
          {
            ...
            origin: url.origin,
            method: request.method,
            body: agent2.isMockActive ? request.body && (request.body.source || request.body.stream) : body,
...
function mappedIpv4(input) {
  const bytes = ipv6Bytes(input);
  if (!bytes || bytes.length !== 16 || !bytes.slice(0, 10).every((b) => b === 0) || bytes[10] !== 255 || bytes[11] !== 255) return null;
...
function privateIp(ip) {
  ...
  return loopback || (bytes[0] & 254) === 252 || bytes[0] === 254 && (bytes[1] & 192) === 128 || bytes[0] === 255;
}
...
var agent = new import_undici.Agent({ connect: { lookup: lookupPublicAddress }, connections: 4 });
...
function parseTargetUrl(input) {
  ...
  if (!u.hostname || !u.hostname.includes(".") && !net2.isIP(u.hostname)) return { ok: false, error: "That doesn't look like a public hostname." };
