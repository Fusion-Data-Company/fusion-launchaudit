...
async function registerArtifactRecord(sql, body, blobPath) {
  try {
    await sql(
...
function artifactPath(body) {
  return `campaigns/${safeSegment2(body.campaign_id)}/runs/${safeSegment2(body.run_id)}/${safeSegment2(body.artifact_type)}/${safeSegment2(body.test_card_id)}-${safeSegment2(body.filename)}`;
}
